...
function EditEnable()
{
    ...
    document.getElementById("submitbutton").innerHTML = "<input type='submit' name='submit'/>"
}
//Asking for confirmation before a users account is deleted
function DeleteAsk()
{
    document.getElementById("delete").innerHTML = "<form action='deleteUser.php' method='post'><p>Enter your username to confirm (this is going to delete all posts and comments aswell)</p><input type='text' name='name'/><input type='submit' name='submit' value='Delete'/></form>";
}